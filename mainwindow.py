...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clear_hint1 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.clear_hint1.setFont(font)
        self.clear_hint1.setObjectName("clear_hint1")
        self.horizontalLayout.addWidget(self.clear_hint1)
        self.copy_hint1 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.copy_hint1.setFont(font)
        self.copy_hint1.setObjectName("copy_hint1")
        self.horizontalLayout.addWidget(self.copy_hint1)
        ...
        self.clear_hint2 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.clear_hint2.setFont(font)
        self.clear_hint2.setObjectName("clear_hint2")
        self.horizontalLayout_2.addWidget(self.clear_hint2)
        self.copy_hint2 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.copy_hint2.setFont(font)
        self.copy_hint2.setObjectName("copy_hint2")
        self.horizontalLayout_2.addWidget(self.copy_hint2)
        ...
        self.clear_hint3 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.clear_hint3.setFont(font)
        self.clear_hint3.setObjectName("clear_hint3")
        self.horizontalLayout_3.addWidget(self.clear_hint3)
        self.copy_hint3 = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.copy_hint3.setFont(font)
        self.copy_hint3.setObjectName("copy_hint3")
        self.horizontalLayout_3.addWidget(self.copy_hint3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.clear_hint1.setText(_translate("MainWindow", "X"))
        self.copy_hint1.setText(_translate("MainWindow", "<"))
        self.label_2.setText(_translate("MainWindow", "Подсказка 2"))
        self.clear_hint2.setText(_translate("MainWindow", "X"))
        self.copy_hint2.setText(_translate("MainWindow", "<"))
        self.label_3.setText(_translate("MainWindow", "Подсказка 3"))
        self.clear_hint3.setText(_translate("MainWindow", "X"))
        self.copy_hint3.setText(_translate("MainWindow", "<"))
